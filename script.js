...
function backgroundGoBack() {
    sayHelloButton.style.backgroundColor = '#EFEFEF'
    sayHelloButton.style.color = 'black'
}

sayHelloButton.addEventListener('mouseout', backgroundGoBack)
...
const repeatMyParam = () => {
    ...
    axios.get('http://localhost:3000/repeat/' + 'Ahhh! I am melting')
    .then((response) => {
...
document.querySelector('#query-button').addEventListener('click', fancyRequest)
...
const form = document.querySelector('#foodBtn')
